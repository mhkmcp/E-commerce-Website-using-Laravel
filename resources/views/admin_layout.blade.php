				...
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li>
							...
							<ul>
								<li><a href="{{URL::to('/add-product')}}"><i class="icon-list-alt"></i><span class="hidden-tablet"> Add Products</span></a>
								</li>
								<li><a href="{{URL::to('/all-product')}}"><i class="icon-edit"></i><span class="hidden-tablet"> All Products</span></a>
								</li>
							</ul>	
						</li>
						...
						<li>
							...
							<ul>
								<li><a href="{{URL::to('/add-slider')}}"><i class="icon-list-alt"></i><span class="hidden-tablet">Add Slider</span></a>
								</li>
								<li><a href="{{URL::to('/all-slider')}}"><i class="icon-edit"></i><span class="hidden-tablet">All Sliders </span></a>
								</li>
							</ul>	
						</li>
